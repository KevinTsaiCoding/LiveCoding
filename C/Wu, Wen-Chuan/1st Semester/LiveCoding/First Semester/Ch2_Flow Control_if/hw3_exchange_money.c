...
int main()
{
	int i,j,giftvalue,exchange,exchange_1,exchange_2;
	int exchange_3,exchange_4,exchange_5,exchange_6;/*i stands for object costs,
	j stands for total numbers of the object.*/
	printf("禮物價格: ");
	scanf("%d", &i);
	printf("禮物個數: ");
	scanf("%d", &j);
